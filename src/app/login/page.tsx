  ...
  return (
    <div className="min-h-screen bg-[#eeeef5] flex items-center justify-center px-4 py-10 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute top-[-80px] left-[-60px] w-[340px] h-[340px] rounded-full bg-[#059669]/10 blur-3xl" />
        <div className="absolute bottom-[-60px] right-[-40px] w-[280px] h-[280px] rounded-full bg-[#10b981]/10 blur-3xl" />
      </div>

      <div className="relative z-10 w-full max-w-[400px] animate-slide-up">

        {/* ── CARD ── */}
        <div className="bg-white rounded-[28px] border border-[#e8e5ed] shadow-[0_20px_60px_rgba(0,0,0,.08)] overflow-hidden">

          {/* Top gradient strip */}
          <div className="h-1 w-full bg-gradient-to-r from-[#17161c] via-[#059669] to-[#17161c]" />

          {/* Hero */}
          <div className="flex flex-col items-center text-center px-8 pt-8 pb-6">
            {/* Logo */}
            <div className="flex items-center gap-2.5 mb-6">
              <span className="flex h-10 w-10 items-center justify-center rounded-[10px] bg-gradient-to-br from-[#17161c] to-[#059669] text-white shadow-[0_4px_12px_rgba(5,150,105,.35)]">
            ...
            <div className="relative w-52 h-36 mb-6">
              {/* Left phone */}
              <div className="absolute left-2 bottom-0 w-20 h-32 bg-white rounded-[20px] border-2 border-[#a7f3d0] shadow-[0_8px_24px_rgba(5,150,105,.12)] flex flex-col items-center justify-center gap-2">
                <div className="w-10 h-10 rounded-2xl bg-[#ecfdf5] flex items-center justify-center">
                  <span className="text-[#059669] font-black text-lg">₹</span>
                </div>
                <div className="w-12 h-1.5 bg-[#a7f3d0] rounded-full" />
                <div className="w-8 h-1 bg-[#e8e5ed] rounded-full" />
              </div>
              {/* Center arrow */}
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 w-11 h-11 rounded-full bg-white border-2 border-[#059669] flex items-center justify-center shadow-lg">
              ...
              {/* Right phone */}
              <div className="absolute right-2 bottom-0 w-20 h-32 bg-gradient-to-b from-[#17161c] to-[#059669] rounded-[20px] shadow-[0_8px_24px_rgba(5,150,105,.30)] flex flex-col items-center justify-center gap-2">
          ...
          <div className="px-8 pb-8 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="relative">
                <button
                  ...
                  className="w-full flex items-center justify-between gap-2 px-3.5 py-3 rounded-[14px] border border-[#e8e5ed] bg-[#f6f5fb] text-[14px] font-semibold text-[#17161c] hover:border-[#059669] transition-colors"
                >
            ...
            <p className="text-center text-[12px] text-[#9592a0]">
              ...
              <a href="#" className="text-[#059669] underline underline-offset-2 hover:text-[#047857]">
                Terms & Conditions
              </a>
            </p>
            ...
            <button
              id="login-button"
              onClick={() => login()}
              className="w-full py-4 rounded-[16px] bg-[#17161c] hover:bg-[#059669] active:scale-[0.98] text-white font-bold text-[16px] tracking-[-0.01em] transition-all shadow-[0_6px_20px_rgba(5,150,105,.25)]"
            >
              Login
            </button>
          </div>
